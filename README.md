...
Formulario	col-lg-6	Formulario centrado.

### Componentes de Bootstrap usados
- Container fluid - Para los fondos que ocupan todo el ancho.
- Grid system - Todo el maquetado con filas y columnas.
- Botones - btn-primary y btn-lg para el de inscripción.
